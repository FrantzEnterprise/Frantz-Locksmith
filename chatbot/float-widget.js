...
const K = {
  lockTypes: [
    { name: "S&G (Sargent & Greenleaf) Combination Lock",
      ...
      dialSequence: "**Standard dialing sequence for S&G, LaGard, Mosler & Big Red locks**\n\n**Important rule:** Your target number is your combination. Anytime you pass that number, it counts as one. After reaching your target, the next number is your target.\n\n**For a 3-number combo (e.g. 25-50-75):**\n1st # → 4 X Left — pass zero 4 times, stop on 25\n2nd # → 3 X Right — pass 25 three times, stop on 50\n3rd # → 2 X Left — pass 50 twice, stop on 75\nTurn RIGHT slowly till it stops (85-95), turn handle\n\n**For a 4-number combo (e.g. 10-20-30-40):**\n1st # → 4 X Left — stop on 10\n2nd # → 3 X Right — stop on 20\n3rd # → 2 X Left — stop on 30\nTurn RIGHT till it stops (around 40)\n\nNo matter how close your next target is to the last — if you pass it, it counts as one. Start that number again.\n\nTip: If dial stops early on final right turn, you overshot. Go back 2 left turns and try again slowly.\n\nNot all locks use the 4-3-2 pattern! Try these alternative sequences:\n\n3-wheel pack (3-2-1 pattern):\n• Option A: 1st # → 3 X Right — 2nd # → 2 X Left — 3rd # → 1 X Right — turn handle\n• Option B (opposite): 1st # → 3 X Left — 2nd # → 2 X Right — 3rd # → 1 X Left — turn handle\n\n4-wheel pack (4-3-2-1 pattern for antiques):\n• 1st # → 4 X Left — 2nd # → 3 X Right — 3rd # → 2 X Left — 4th # → 1 X Right — you must stop on the 4th number yourself, then handle\n\nQuick test: Try turning handle toward open WITHOUT dialing. If dial doesn't rotate or feels rough, it's not a standard 4-3-2 lock — try 3-2-1 patterns first.\n\nIf nothing works, call (916) 534-4900. This is exactly what I deal with daily.",
      tip: "If the dial stops earlier than expected on the last right turn, you overshot. Go back 2 full turns and try again slowly. Antique locks vary widely — don't force anything." },
